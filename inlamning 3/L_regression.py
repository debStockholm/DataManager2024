...
#ALTERNETIV 1: om jag kor en LR vill jag nog ha de varderna som tillater mig gora det mest akkurata prediction. Jag tycker det ar rimligt
...
# x=df_LR[['jan_kg','feb_kg','mars_kg' ,'apr_kg']]
...
#matsvinn_keyvalues=df[['Kökssvinn(i kg) januari','Kökssvinn(i kg) februari','Kökssvinn(i kg) mars', 'Kökssvinn(i kg) april'] ].round(2).agg('mean')
...
# # x_axis = [[i] for i in range(len(x) + 3)]
