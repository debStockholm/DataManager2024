...
###################________________________________2024______________________________________

df = pd.read_csv('2024 jan.csv')
df2= pd.read_csv('2024 feb.csv')
df3= pd.read_csv('2024 mar.csv')
df4= pd.read_csv('2024 apr.csv')
...
# merging_files_2= pd.merge(merging_files, ny_df3, on = 'Enhet', how = 'inner')
# print(merging_files_2)
# merging_files_2=merging_files_2.rename(columns={'Kökssvinn  (i kg)_x': 'jan_24', 'Kökssvinn  (i kg)_y': 'feb_24',  'Kökssvinn  (i kg)': 'mars_24'})
# merge2024= pd.merge(merging_files_2, ny_df4, on = 'Enhet', how = 'inner')
# merge2024=merge2024.rename(columns={'Kökssvinn  (i kg)': 'apr_24'})
# print(merge2024)
...
# matsvinn_2024_mean=merge2024[['jan_24','feb_24','mars_24', 'apr_24']].agg('mean')
# matsvinn_2024_mean=matsvinn_2024_mean[['jan_24','feb_24','mars_24', 'apr_24']].round(2).astype(float)
# matsvinn_2024_sum=merge2024[['jan_24','feb_24','mars_24', 'apr_24']].agg('sum')
# matsvinn_2024_sum=matsvinn_2024_sum[['jan_24','feb_24','mars_24', 'apr_24']].astype(int)


# print(matsvinn_2024_mean)
# print(matsvinn_2024_sum)

# matsvinn_2024_mean.to_csv('Medel_matsvinn_2024.csv', index=False)
# matsvinn_2024_sum.to_csv('Sum_matsvinn_2024.csv', index=False)
